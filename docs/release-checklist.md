...
Use this checklist before cutting a public release for agent-evidence-binder-skill.
...
- Exercise the CLI smoke path for `agent-evidence-binder` with the checked-in fixture.
